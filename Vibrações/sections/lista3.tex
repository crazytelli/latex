...
%\[
    %\cancel{\frac{1}{2}}\cdot m_{eq}\cdot\bcancel{\dot{x}_s^2} = \cancel{\frac{1}{2}}m_s\cdot \dot{x}_s^2 + \cancel{\frac{1}{2}}J_s\cdot \left( \frac{\dot{x}_s}{r_s} \right)^2 + \cancel{\frac{1}{2}}J_0\cdot \left( \frac{\dot {x}_s}{l_2} \right)^2 + \cancel{\frac{1}{2}}\clot \left( \frat{\dot {x}_s\clot l_1}{l_2} \right)^2
%\]

Multiplicando ambos os lados da equação por 2 e dividindo por $\dot{x}_s$ cancela-se esses termos obtendo a equação:
